using SmartLGU.Domain.Events;
using Microsoft.Extensions.Logging;

namespace SmartLGU.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("SmartLGU Domain Event: {DomainEvent}", notification.GetType().Name);
