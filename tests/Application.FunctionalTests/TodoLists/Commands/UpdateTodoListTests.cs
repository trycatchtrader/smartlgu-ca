using SmartLGU.Application.Common.Exceptions;
using SmartLGU.Application.TodoLists.Commands.CreateTodoList;
using SmartLGU.Application.TodoLists.Commands.UpdateTodoList;
using SmartLGU.Domain.Entities;

namespace SmartLGU.Application.FunctionalTests.TodoLists.Commands;
